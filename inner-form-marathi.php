<div class="col-md-5 col-lg-5">
    <div class="form-wrp">
        <form method="post" id="innerForm">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="pbmit-titlee">अधिक माहितीसाठी आमच्याशी संपर्क साधा.</h2>
                </div>

                <div id="inner_check" class="col-md-12"></div>

                <div class="col-md-12">
                    <input type="text" name="inner_name" id="inner_name" class="form-control" placeholder="तुमचे नाव" required>
                </div>

                <div class="col-md-12">
                    <input type="tel" name="inner_phone" id="inner_phone" class="form-control" placeholder="फोन" required>
                </div>
                ...
                <div class="col-md-12">
                    <textarea name="inner_message" id="inner_message" rows="3" class="form-control" placeholder="तुमचा संदेश" style="display:none;">Enquiry from inner form</textarea>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#innerForm').submit(function(e) {
            ...
            if (name == "" || !name.match(name_regex)) {
                $('#inner_check').html('** कृपया तुमचे नाव प्रविष्ट करा **').css("color", "red");
                $("#inner_name").focus();
                return false;
            }

            if (phone == "" || !phone.match(mobile_regex)) {
                $('#inner_check').html('** कृपया वैध 10 अंकांचा फोन नंबर प्रविष्ट करा **').css("color", "red");
                $("#inner_phone").focus();
                return false;
            }

            if (email == "" || !email_regex.test(email)) {
                $('#inner_check').html('** कृपया वैध ईमेल प्रविष्ट करा **').css("color", "red");
                $("#inner_email").focus();
                return false;
            }

            if (subject == "") {
                $('#inner_check').html('** कृपया विषय प्रविष्ट करा **').css("color", "red");
                $("#inner_subject").focus();
                return false;
            }
