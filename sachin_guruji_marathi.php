	...
	<div class="row g-0 justify-content-center" style="padding: 15px; border-radius: 20px; background-image: linear-gradient(1deg, #fdfcf7bf 50%, transparent); border: 1px solid #ffffff;">
		<div class="col-12">
			<div>
				...
				<p>अधिक माहितीसाठी, <strong>Call: <a href="tel:+919552095159;">(+९१) ९५५२० ९५१५९</a></strong></p>
			</div>
		</div>
		<div class="col-6 col-md-4">
			<div class="pbminfotech-fidbox-style-7">
				<div class="pbminfotech-fld-contents">
					...
					<h3 class="pbminfotech-fid-title"><span>वर्षे अनुभव</span></h3>
				</div>
			</div>
		</div>
		<div class="col-6 col-md-4">
			<div class="pbminfotech-fidbox-style-7">
				<div class="pbminfotech-fld-contents">
					...
					<h3 class="pbminfotech-fid-title"><span>फोन कंसल्टेशन्स</span></h3>
				</div>
			</div>
		</div>
		<div class="col-6 col-md-4">
			<div class="pbminfotech-fidbox-style-7">
				<div class="pbminfotech-fld-contents">
					...
					<h3 class="pbminfotech-fid-title"><span>साक्षर अभ्यास</span></h3>
				</div>
			</div>
		</div>
		<div class="col-6 col-md-4">
			<div class="pbminfotech-fidbox-style-7">
				<div class="pbminfotech-fld-contents">
					...
					<h3 class="pbminfotech-fid-title"><span>वस्तू पूजा</span></h3>
				</div>
			</div>
		</div>
		<div class="col-6 col-md-4">
