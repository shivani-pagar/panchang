                  ...
                  <div class="pbmit-title-bar-content-inner">
                     <div class="pbmit-tbar">
                        <div class="pbmit-tbar-inner container">
                           <h1 class="pbmit-tbar-title">Navagraha Shanti Pooja Trimbakeshwar</h1>
                        </div>
                     </div>
                     <div class="pbmit-breadcrumb">
                        <div class="pbmit-breadcrumb-inner">
                           ...
                           <span class="sep">-</span>
                           <span><span class="post-root post post-post current-item">Navagraha Shanti Pooja</span></span>
                        </div>
                     </div>
                  </div>
               </div>
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-md-6 col-lg-6"> 
								...
								<h3 class="pbmit-title">Navagraha Shanti</h3>
								<p>According to Vedas and Shastras there are many planets & stars but only Nine (Nav=9) Planets (Grah) and 27stars that fell into immediate circumference of the solar system and are likely to affect our lives depending upon their position in our natal chart are considered.	</p>
								<p>These nine planets form an orbit called as Navagraha Mandal.</p>
								<p>The nine "grahas" or planets in our horoscope control our karma, our desires and their outcomes.</p>
								<p>Each of these nine planets exerts an influence in our lives, which is called "dasa" and it can be known from one's horoscope. Navagraha Shanti pooja is undertaken to reduce the pessimistic effects and improve the optimistic energies related to a person.</p>
								<p>The nine planets have special kshetras ( place of worship ) in South India. Most of them are concentrated near the Thanjavur district. Navagraha pooja will be helpful, when the concerned planet dasa or sub-dasa is in operation or if the planet is associated with malefics or is in the 3rd, 6th, 8th, or 12th house.</p>
								<p>Also as said earlier only 9 planets and 27 stars are considered.</p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="service-page-infobox">
									<div class="row align-items-center">
										<div class="col-md-6">
											<img src="images/guruji/ser-img/navgrahphoto.jpg" class="img-fluid" alt="">
										</div>
										<div class="col-md-6">
											<div class="service-list-group">
												<h3 class="pbmit-title" >Navagraha Pooja Vidhi:</h3>
												<ul class="serul">
												<li>Chant the Navagraha Mantras.</li>
												<li>Offer fruits, sweets, incense to appease the Navagrahas.</li>
												<li>  Homam or fire ritual.</li>
												</ul>
											</div>
										</div>
									</div>
