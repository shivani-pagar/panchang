            ...
            <div class="col-lg-8">
                <div class="contact-form-wrapper p-4 p-md-5 bg-white shadow-sm" style="border-radius: 20px; border-top: 5px solid #D32F2F;">
                    <div class="pbmit-heading-subheading mb-4">
                        <h4 class="pbmit-subtitle text-orange fw-bold text-uppercase" style="color: #ff8c00; letter-spacing: 2px;">Stay in touch.</h4>
                        <h2 class="pbmit-title display-6 fw-bold">Contact <strong style="color: #D32F2F;"> us</strong></h2>
                    </div>
                    ...
                    <form method="post" id="contactForm">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="name" id="name" class="form-control classic-input" placeholder="Your Name" required="">
                            </div>
                            <div class="col-md-6">
                                <input type="tel" name="phone" id="phone" class="form-control classic-input" placeholder="Mobile Number" required="">
                            </div>
                            <div class="col-md-6">
                                <input type="email" name="email" id="email" class="form-control classic-input" placeholder="Email" required="">
                            </div>
                            <div class="col-md-12">
                                <textarea name="message" id="message" cols="40" rows="4" class="form-control classic-input" placeholder="Your Message" required=""></textarea>
                            </div>
                ...
                <div class="contact-info-sidebar h-100 d-flex flex-column gap-4 py-md-2">
                    <div class="classic-info-card p-4 bg-white shadow-sm">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="info-details">
                                <h5 class="fw-bold mb-1" style="color: #D32F2F;">Email</h5>
                                <a href="mailto:panchangvaastu@gmail.com" class="text-decoration-none text-muted">panchangvaastu@gmail.com</a>
                                <div class="mt-3">
                                    <a href="mailto:panchangvaastu@gmail.com" class="pbmit-btn-sm-classic">Mail</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="classic-info-card p-4 bg-white shadow-sm">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="info-details">
                                <h5 class="fw-bold mb-1" style="color: #D32F2F;">Phone</h5>
                                <a href="tel:+919552095159" class="text-decoration-none text-muted">(+91) 95520 95159</a>
                                <div class="mt-3">
                                    <a href="tel:+919552095159" class="pbmit-btn-sm-classic">Call Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="classic-info-card p-4 bg-white shadow-sm border-gold-left">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="info-details">
                                <h5 class="fw-bold mb-1" style="color: #D32F2F;">Address</h5>
                                ...
                                <div class="mt-3">
                                    <a href="#map" class="pbmit-btn-sm-classic">View Address</a>
                                </div>
                            </div>
                        </div>
                    </div>
