            ...
            <div class="row g-0">
                ...
                <div class="col-md-4 border-end-custom">
                    <div class="counter-item-box text-center p-4">
                        ...
                        <h3 class="counter-title">|| वैदिक शास्त्र ||</h3>
                        <p class="counter-desc">शास्त्रोक्त विधी आणि पूजा मार्गदर्शन</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="counter-item-box text-center p-4">
                        ...
                        <h3 class="counter-title">|| वास्तुशास्त्र ||</h3>
                        <p class="counter-desc">समृद्धीसाठी शास्त्रीय वास्तु उपाय</p>
                    </div>
                </div>
