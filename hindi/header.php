...
<head>
    ...
    <title>पंचांग वास्तु – भारत में एक्सपर्ट वास्तु शास्त्र कंसल्टेंट</title>
    ...
    <div class="navbar-container">
        ...
        <nav class="navbar">
            ...
            <a href="index.php" class="navbar-logo">
                <img src="images/guruji/panchang-vastu-logo.webp"" alt=" Logo" class="logo-img">
                <div class="logo-text">
                    <div class="logo-title">पंचांग वास्तु</div>
                    <div class="logo-subtitle">वैदिक समाधान</div>
                </div>
            </a>
            ...
            <ul class="nav-menu" id="nav-menu">
                ...
                <!-- Services Dropdown - FIXED: Now using li elements instead of div -->
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link">
                        <i class="fas fa-hands-praying nav-icon"></i>
                        <span>सर्वोत्तम सेवाएं</span>
                    </a>
                ...
                <li class="nav-item">
                    <a href="pictures_images.php" class="nav-link">
...
<script>
    ...
    document.querySelectorAll('.dropdown > .nav-link').forEach(item => {
    ...
    document.querySelectorAll('.dropdown-submenu > .dropdown-item').forEach(item => {
        item.addEventListener('click', function(e) {
            if (window.innerWidth <= 992) {
                ...
                const siblings = parent.parentElement.querySelectorAll('.dropdown-submenu.active');
    ...
    window.addEventListener('scroll', function() {
        ...
        if (window.scrollY > 50) {
            ...
            navbar.style.boxShadow = '0 5px 25px var(--shadow)';
        }
    });

    // Close dropdowns when clicking on a dropdown item (for desktop)
