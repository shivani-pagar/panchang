                    ...
                    <div class="pbmit-title-bar-content-inner">
                        <div class="pbmit-tbar">
                            <div class="pbmit-tbar-inner container">
                                <h1 class="pbmit-tbar-title">हमसे संपर्क करें</h1>
                            </div>
                        </div>
            ...
            <div class="col-lg-8">
                <div class="contact-form-wrapper p-4 p-md-5 bg-white shadow-sm" style="border-radius: 20px; border-top: 5px solid #D32F2F;">
                    <div class="pbmit-heading-subheading mb-4">
                        ...
                        <h2 class="pbmit-title display-6 fw-bold">हमसे <strong style="color: #D32F2F;">संपर्क करें</strong></h2>
                    </div>
                    ...
                    <form method="post" id="contactForm">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="name" id="name" class="form-control classic-input" placeholder="आपका नाम" required="">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <textarea name="message" id="message" cols="40" rows="4" class="form-control classic-input" placeholder="आपका संदेश" required=""></textarea>
                            </div>
                            ...
                            <div class="col-md-12 text-center text-md-start">
                                <button type="submit" id="submit_btn" class="pbmit-btn btn-classic-submit">
                                    ...
                                    <span class="btn-text">मेसेज भेजें</span>
                    ...
                    <div class="classic-info-card p-4 bg-white shadow-sm">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="info-details">
                                ...
                                <div class="mt-3">
                                    <a href="mailto:panchangvaastu@gmail.com" class="pbmit-btn-sm-classic">मेल</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="classic-info-card p-4 bg-white shadow-sm">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="info-details">
                                ...
                                <div class="mt-3">
                                    <a href="tel:+919552095159" class="pbmit-btn-sm-classic">कॉल करें</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="classic-info-card p-4 bg-white shadow-sm border-gold-left">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="info-details">
                                ...
                                <div class="mt-3">
                                    <a href="#map" class="pbmit-btn-sm-classic">पता देखें</a>
                                </div>
                            </div>
                        </div>
                    </div>
