			...
			<div class="row align-items-center">
				...
				<div class="col-md-12 col-lg-6 animate__animated animate__fadeInRight">
					<div class="about-content-box ps-lg-4">
						...
						<p class="intro-para">
							मानवी जीवनाचा पाया आणि निसर्गाचा संतुलन हे <strong>पंचतत्त्वांवर</strong> आधारित आहे. अग्नी, पृथ्वी, वायू, जल आणि आकाश ही पंचतत्त्वे जीवनात योग्य प्रमाणात संतुलित असणे अत्यंत आवश्यक आहे. पंचतत्त्वांमध्ये कमतरता किंवा अतिरेक झाल्यास जीवनात विविध अडचणी निर्माण होतात.
						</p>

						<div class="focus-box">
							<p>
								आपले <strong>पंचांग वास्तु असोसिएट्स</strong> हे पंचतत्त्व संतुलित करण्यासाठी प्राचीन ग्रंथांच्या आधारे प्रामाणिक प्रयत्न करते. त्या शास्त्रीय मार्गदर्शनाच्या मदतीने आम्ही मानवी जीवन अधिक सकारात्मक, संतुलित आणि समृद्ध बनवण्यासाठी कार्य करतो.
							</p>
						</div>

						<p class="guruji-note">
							<strong>सचिन जोशी</strong> यांच्या मार्गदर्शनाखाली आमचे ध्येय वास्तुशास्त्र आणि जीवनातील इतर प्रमुख घटक यांचा योग्य समतोल साधणे आणि तुमच्या जीवनात सकारात्मक बदल घडवून आणणे हे आहे.
						</p>

						<div class="quote-box">
							<p>“संकल्पात जायते सिद्धी” — यश हे दृढनिश्चयातूनच जन्माला येते. तुमच्या जीवनाच्या प्रत्येक पैलूमध्ये सुसंवाद, शांती आणि यशाच्या मार्गावर योग्य मार्गदर्शन करण्यासाठी आम्ही पूर्णपणे समर्पित आहोत.</p>
						</div>

						<a href="about.php" class="btn-modern-about">
							अधिक वाचा <i class="fas fa-arrow-right ms-2"></i>
						</a>
					</div>
				</div>
			...
			<div class="row align-items-center mb-5">
				<div class="col-lg-5">
					<div class="section-title-area">
						...
						<h2 class="display-6 fw-bold text-dark">आमच्या पूजा सेवा – <span style="color: #c39b2e;">सचिन जोशी</span></h2>
			...
			<div class="row g-4">
				...
				<div class="col-md-4">
					<div class="premium-service-card">
						...
						<div class="service-info text-center p-4">
							<h3 class="fw-bold h4 mb-3">|| वैदिक शास्त्र ||</h3>
